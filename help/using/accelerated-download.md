...
To configure specific tenants for accelerated file download, administrators [!UICONTROL Enable Download Acceleration] (which is disabled by default) from [!UICONTROL General Settings] in the administrative tools panel.
...
1. Go to [!UICONTROL Network and Internet > Internet Options]. Click the **Security **tab.
...
1. To confirm whether the downloads from Aspera demo server are working, use [https://demo.asperasoft.com/aspera/user](https://demo.asperasoft.com/aspera/user).  (`login:  asperaweb , password:  demoaspera`)
